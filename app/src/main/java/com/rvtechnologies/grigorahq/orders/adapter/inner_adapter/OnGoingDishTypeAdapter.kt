...
class OnGoingDishTypeAdapter(val list: ArrayList<HomeModel.Data.OrderDetail.ItemChoice.ItemSubCategory> = ArrayList()) :
    RecyclerView.Adapter<OnGoingDishTypeAdapter.ViewHolder>() {
