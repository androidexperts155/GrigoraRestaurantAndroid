...
class PastDishTypeAdapter(val list: ArrayList<RestaurantPastOrders.Data.OrderDetail.ItemChoice.ItemSubCategory> = ArrayList()) :
    RecyclerView.Adapter<PastDishTypeAdapter.ViewHolder>() {
