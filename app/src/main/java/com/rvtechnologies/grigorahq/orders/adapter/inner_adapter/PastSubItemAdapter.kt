...
class PastSubItemAdapter(val list: ArrayList<RestaurantPastOrders.Data.OrderDetail> = ArrayList()) :
    RecyclerView.Adapter<PastSubItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.rv_dishItem.adapter = PastDishTypeAdapter(item_sub_list)
    }
